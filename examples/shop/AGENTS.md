...
short, human and to the point. Say the thing, then stop.

- **No slop.** No filler, no restating the diff, no recap, no stacked caveats.
- **No attributions.** No "Generated with …" footers, no `Co-Authored-By`
  trailers, no tool signatures.
- **Comments** explain the non-obvious why, in a sentence or two.
- **PR and review comments** give the answer or finding and the evidence in a
  line; point to the commit rather than retelling it.
