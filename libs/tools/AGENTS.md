...
Deploys the 31 published Wagoe libraries to Clojars — `wagoe-tools` among them, as `com.wagoe/wagoe-tools`.
...
| `wagoe.tools.deploy` | Clojars deployment for all 31 published Wagoe artifacts |
