...
(defn generate-module-wiring-file
  ...
  \"Integrant wiring for the %s module.
   ...
   Generated by `bb scaffold`. `bb scaffold integrate` adds the :wagoe/%s key
   to your system config; these methods are what that key resolves to.
...
;; =============================================================================
;;
;; What discovery looks for. The system config emits :wagoe/%s when the module
;; is enabled, and this key is what makes its routes reachable — returning them
;; is how the HTTP handler finds them without the application naming this module
;; anywhere.
...
"
            ...
            module-name entity-name
            module-name
            module-name entity-name entity-name
            module-name entity-name)))
