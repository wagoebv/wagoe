...
(defn generate-module-wiring-file
  ...
  \"Integrant wiring for the %s module.
   ...
   Generated by `bb scaffold`. `bb scaffold integrate` prints the config this
   module needs; these methods are what that config resolves to. (integrate
   writes it for you once BOU-310 lands — until then, paste it.)
