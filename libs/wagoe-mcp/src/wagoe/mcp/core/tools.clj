    ...
    :inputSchema {:type       "object"
                  :properties {"module"   {:type        "string"
                               ...
                               "interfaces" {:type       "object"
                                             :description "Which interfaces to generate. Both default to true — omit this to get the whole module. Pass web=false to skip core/ui.clj, shell/web_handlers.clj and the module's :web routes; http=false to skip the REST API routes. API routes and the web page require a signed-in user; public-api=true opens both to anyone."
                                             :properties {"http" {:type "boolean"} "web" {:type "boolean"} "public-api" {:type "boolean"}}}
