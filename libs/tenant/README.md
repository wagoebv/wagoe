...
clojure -M:test:test/pg :tenant --focus wagoe.tenant.*

# Specific test suites
clojure -M:test:test/pg :tenant --focus wagoe.tenant.core.tenant-test         # Unit tests
clojure -M:test:test/pg :tenant --focus wagoe.tenant.shell.service-test       # Service tests
clojure -M:test:test/pg :tenant --focus wagoe.tenant.shell.provisioning-test  # Provisioning tests
```
