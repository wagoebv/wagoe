...
* https://github.com/wagoebv/wagoe-starter[boundary-starter] — project scaffolding wizard
* https://github.com/wagoebv/wagoe-examples[boundary-examples] — reference applications (ecommerce-api, blog-app, and more)
