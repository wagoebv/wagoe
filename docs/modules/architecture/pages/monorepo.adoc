...
* https://github.com/wagoebv/wagoe-starter[wagoe-starter] — project scaffolding wizard
* https://github.com/wagoebv/wagoe-examples[wagoe-examples] — reference applications (ecommerce-api, blog-app, and more)
