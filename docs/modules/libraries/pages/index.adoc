= Library Overview
:description: All 29 independently publishable Wagoe libraries, application and tooling alike.

Wagoe is a monorepo of 29 libraries published to Clojars under the `com.wagoe`
group.
