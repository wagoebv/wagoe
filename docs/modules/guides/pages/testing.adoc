...
# By tag
clojure -M:test:test/all --focus-meta :unit
clojure -M:test:test/all --focus-meta :integration
clojure -M:test:test/all --focus-meta :contract

# Single namespace
clojure -M:test:test/all --focus user-property-test
