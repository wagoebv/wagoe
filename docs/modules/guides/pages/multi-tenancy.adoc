...
# Focused suites
clojure -M:test:db/h2 --focus wagoe.tenant.core.membership-test
clojure -M:test:db/h2 --focus wagoe.tenant.shell.membership-service-test
clojure -M:test:db/h2 --focus wagoe.tenant.shell.invite-service-test
clojure -M:test:db/h2 --focus wagoe.tenant.integration-test
----
