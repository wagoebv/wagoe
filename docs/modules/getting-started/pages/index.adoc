= Getting Started
:description: A concise path from first install to first Wagoe module.
...
| 1. Install
| Get Java 21+, the Clojure CLI, and Babashka.

| 2. Bootstrap
| Run `wagoe new <app>` and answer the setup prompts.
