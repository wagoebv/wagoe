...
| Stability
| Release candidate. The `1.0.0` surface is frozen: no breaking change lands
  between `1.0.0-rc-1` and `1.0.0`. Everything deprecated is deferred to `2.0`
  — see <<_deferred_to_2_0,Deferred to 2.0>>.
