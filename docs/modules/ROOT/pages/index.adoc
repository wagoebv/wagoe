...
* *23 independently publishable libraries* on Clojars — use only what you need (plus `wagoe-cli` and `boundary-devtools`)
...
[source,bash]
----
# Install Wagoe (JVM, Clojure CLI, Babashka, bbin, boundary CLI)
