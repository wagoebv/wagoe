...
[source,bash]
----
JWT_SECRET="dev-secret-at-least-32-characters-long" clojure -M:test:test/all
----
...
[source,bash]
----
clojure -M:test :user --focus wagoe.user.core.user-test
clojure -M:test:test/pg :admin --focus wagoe.admin.core.entity-test
----
...
[source,bash]
----
clojure -M:test:test/all --watch                           # Watch all tests
clojure -M:test --watch :core                     # Watch core library
clojure -M:test:test/all --watch --focus-meta :unit        # Watch unit tests
clojure -M:test :user --watch --focus wagoe.user.core.user-test  # Watch specific namespace
----
...
[source,bash]
----
UPDATE_SNAPSHOTS=true clojure -M:test:test/all \
...
See link:../../docs/modules/libraries/pages/scaffolder.adoc[Scaffolder Reference] for complete options.
...
bb ai explain --file stacktrace.txt         # Explain error from file (experimental)
bb ai gen-tests <file>                      # Generate test namespace (experimental)
bb ai gen-tests <file> -o <output>          # Write tests to file (experimental)
bb ai sql "find active users with orders"   # Generate HoneySQL from description (experimental)
...
clojure -M:test :user --watch --focus wagoe.user.core.user-test
...
* link:../../docs/modules/guides/pages/testing.adoc[Run Tests in Watch Mode] - Detailed testing guide
* link:../../docs/modules/guides/pages/debugging.adoc[Troubleshooting Guide] - Common issues and solutions
