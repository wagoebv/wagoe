...
[source,bash]
----
JWT_SECRET="dev-secret-at-least-32-characters-long" clojure -M:test
----
...
[source,bash]
----
clojure -M:test --focus wagoe.user.core.user-test
clojure -M:test --focus wagoe.admin.core.entity-test
----
...
[source,bash]
----
clojure -M:test --watch                           # Watch all tests
clojure -M:test --watch :core                     # Watch core library
clojure -M:test --watch --focus-meta :unit        # Watch unit tests
clojure -M:test --watch --focus wagoe.user.core.user-test  # Watch specific namespace
----
...
clojure -M:test --watch --focus wagoe.user.core.user-test
