...
The Wagoe Framework provides a comprehensive Docker-based development
...
. Select `wagoe-dev-tools` container
...
* *App container*: `wagoe` user (UID 1001)
* *Database*: `postgres` user
* *Docs*: `node` user

==== Network Isolation

* *Custom network*: Services communicate via `wagoe-network`
...
* link:../libs/platform/src/wagoe/platform/shell/utils/port_manager.clj[Port Management
System]
