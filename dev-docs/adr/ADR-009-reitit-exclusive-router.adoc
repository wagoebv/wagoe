...
1. ✅ **Deleted Pedestal adapter draft code**
   - `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/wagoe/platform/shell/http/pedestal_router.clj`
...
- **Reitit Adapter**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/wagoe/platform/shell/http/reitit_router.clj`
- **IRouter Protocol**: `link:https://github.com/thijs-creemers/boundary/blob/main/libs/platform/src/wagoe/platform/ports/http.clj`
