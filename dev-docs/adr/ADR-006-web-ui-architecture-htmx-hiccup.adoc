...
**Shared UI Component Library** - `link:https://github.com/thijs-creemers/boundary/blob/main/libs/shared-ui/src/wagoe/shared/ui/core/`
...
- link:../reference/boundary-prd.adoc[Product Requirements Document] - Product vision and requirements
